  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: farmsAsync.when(
        ...
        data: (farms) => farms.isEmpty
            ? JmEmptyState(
                ...
                title: 'No Lands Yet',
                subtitle: 'Add your farmland to start receiving bookings from shepherds.',
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('Add Land', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
      ),
    );
  }
}
...
class _FarmCard extends ConsumerWidget {
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Expanded(
                        child: Text(farm.title, style: Theme.of(context).textTheme.titleMedium,
                  ...
                  Row(
                    children: [
                      ...
                      Text(farm.village, style: Theme.of(context).textTheme.bodySmall),
                      const SizedBox(width: AppSpacing.md),
                      const Icon(Icons.landscape_rounded, size: 14, color: AppColors.textSecondary),
                      const SizedBox(width: 4),
  ...
  Widget _placeholder() => Container(
    ...
    child: const Icon(Icons.landscape_rounded, size: 48, color: AppColors.textDisabled),
  );
}
